...
from src.providers.teideindustrialsa.catalog import classify_document_kind
...
TOKEN_REPLACEMENTS = {
    ...
    "FILTRE": "FILTRO",
    "AMPLE": "ANCHA",
    "ANCHAEXCENTRICA": "ANCHA EXCENTRICA",
}
...
def resolve_reference(reference: str, name: str, catalog_rows: list[dict]) -> dict:
    ...
    if not catalog_rows:
        return _build_not_found(reference, name, "teideindustrialsa_catalog_empty")
    ...
    if best_row is None or best_score < 120:
        return _build_not_found(reference, name, "teideindustrialsa_no_catalog_match")
    ...
    return {
        ...
        "fallback_title": "",
        "fallback_pdf_url": "",
        "notes": "teideindustrialsa_catalog_match",
    }
