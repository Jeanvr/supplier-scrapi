...
from src.providers.aquaramvalvesfittingsslch.catalog import classify_document_kind
...
def resolve_reference(reference: str, name: str, catalog_rows: list[dict]) -> dict:
    ...
    if not catalog_rows:
        return _build_not_found(reference, name, "aquaramvalvesfittingsslch_catalog_empty")
    ...
    if best_row is None or best_score < 160:
        return _build_not_found(reference, name, "aquaramvalvesfittingsslch_no_catalog_match")
